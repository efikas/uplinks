...
if( isset($_POST['userN']) ) {
    ...
    $ref_id =  $row['myid'];
    $query= mysqli_query($dbc,"SELECT * FROM `user_table` WHERE superior_id='$myid' AND `myid`='$ref_id'");
    $row = mysqli_fetch_array($query);
}
if(isset($_GET['page'])){
                ...
                <div class="panel-body">
                  ...
                  <table class="table datatable dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                    ...
                    <?php if( isset($_POST['userN']) ) {
                        ...
                        $ref_status[$i]= get_stage_name($row['myid']);
                        $Date[$i]= $row['added'];
                    ...
                    <tbody>
            	          ...
            	          <?php
                            $me= $userRow['email'];
                            $query=mysqli_query($dbc,"SELECT * FROM `user_table` WHERE superior_id='$myid' LIMIT ".(($page-1)*$itemsperpage).','.$itemsperpage);
                            $i= 1;
