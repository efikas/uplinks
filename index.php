                ...
                <section class="panel" style="width:333px !important;">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                            ...
                            <?php if($error ==true){
                                ?>
                                <div style="color:red; font-size:14px; font-weight:bold; text-align: center;"><span style="color:#F00;padding-left:0px;"><?php echo $errMSG;?></span><br><br></div>

                                <?php
                            } ?>
                            <p></p>

                            <div style="color:red; font-size:14px; font-weight:bold; text-align: center;"><span style="color:#F00;padding-left:0px;"><?php echo $log_msg; ?></span><br><br></div>
