...
.percentbar div { background: #daa520; height: 30px; border-radius: 7px;border: medium none;}
  ...
  <body class="">
    ...
    <div class="animsition" style="animation-duration: 1.5s; opacity: 1;">  
      ...
      <div id="sidebar" style="position:fixed !important;background:#daa520;">
        <div class="slimScroll" style="position: relative; overflow: hidden; width: 100%; height: 609px;"><div class="sidebar_scroll" style="overflow: hidden; width: 100%; height: 609px;"> <!-- start of slimScroll -->
  ...
  <li><a target="_self" href="#"> <i class="ti-receipt"></i> <span>My Income Report </span> <i class="pull-right has-submenu ti-angle-right"></i> </a>
            ...
            <li><a target="_self" href="external-fund-tranfer.php">e-Wallet Fund Transfer</a></li>
           ...
           <li><a target="_self" href="#"> <i class="ti-user"></i> <span>My Members Report</span> <i class="pull-right has-submenu ti-angle-right"></i> </a>
            ...
            <li> <a href="<?php echo $url.'/reg.php?ref='.$myid;  ?>" target="_blank"> <i class="ti-desktop"></i> <span>Register Member</span></a> </li>
...
<!--<li>
 ...
 <!-- <li>
  ...
  <li><a target="_self" href="#"> <i class="ti-ticket"></i> <span>Administrative Tools</span> <i class="pull-right has-submenu ti-angle-right"></i> </a>
              <ul class="nav nav-submenu submenu-hidden">
              <li> <a href="listmember" target="_self"> View all Member</a> </li>
            <li> <a href="admin_messages" target="_self"> Members Tickets</a> </li>
            <li> <a href="view_withdrawal_requests" target="_self">View Withdrawal Requests</a> </li>
            <li> <a href="view_to_fund" target="_self">Fund Members Wallet</a> </li>
