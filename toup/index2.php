...
font-family:Arial, Helvetica, sans-serif;
        ...
        <section id="page-title" class="row">
          ...
          <div class="col-md-12 animateme scrollme" data-when="enter" data-from="0.2" data-to="0" data-crop="false" data-opacity="0" data-scale="0.5">
            <h1> Dashboard  (Your User Id : <?php echo $myid;?>) <span style="float:right;"><img src="dashboard_files/logo-inverse.png" style="height:40px;width:200px;margin-top:-15px;"></span></h1> 
                                    ...
                                    <div class="panel-heading noborder">
                                        ...
                                        <div class="clearfix mt20">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <h4 class="nomargin white">USD <?php echo $Matching_total; ?> </h4>
                                            </div>
                                        </div>
