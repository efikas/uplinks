					...
					<div class="panel panel-primary">
						...
						<div class="text-center" style="padding:20px 20px ; font-color:000;">
						   ...
						   <br>
							...
							<a href="http://www.facebook.com/sharer.php?u=http://uplinks.biz/reg.php?<?php echo $myid;?>" target="_blank"><img src="images/sfacebook.png" width="165"></a> &nbsp;

							<a href="http://twitter.com/share?url=http://uplinks.biz/reg.php?<?php echo $myid;?>" target="_blank"><img src="images/stwitter.png" width="165"></a> &nbsp;
					  
						  
							<a href="https://plusone.google.com/_/+1/confirm?hl=en&amp;url=http://helpinghandsintl.biz/reg.php?<?php echo $myid;?>" target="_blank"><img src="images/sg.png" width="165"></a>
							<br>
