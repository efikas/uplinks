...
$t_passError = "";
 ...
 if( !$error )   {
    ...
    $res = mysqli_query($dbc,"UPDATE `user_table` SET `firstName` = '$firstname',`lastName` = '$lastname', `state` = '$state',`city` = '$city',`phoneNo` = '$phone',`dob` = '$dob',`marital` = '$marital', `address` = '$address' WHERE `email`='$emai'");
            ...
            <div class="col-md-6 animateme scrollme" data-when="enter" data-from="0.2" data-to="0" data-crop="false" data-opacity="0" data-scale="0.5">
              ...
              <section class="panel">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input name="email" class="form-control" id="exampleInputEmail1" readonly="" value="<?php echo $emai; ?>" disabled="" type="email">
                      </div>
                    </div>
                ...
                <span class="text-danger"><?php echo $passError; ?></span>
                   ...
                   <div class="form-group col-md-6 no-left-padding">
                      <label for="exampleInputPassword2">Transaction Pass:</label>
                ...
                <span class="text-danger"><?php echo $t_passError; ?></span>
                    ...
                    <div class="form-group col-md-6 no-right-padding">
                      <label>Country</label>
                      <select class="form-control"  disabled="disabled" name="first_name7" readonly="">
                    ...
                    <div class="form-group col-md-6 no-right-padding">
                      ...
                      <input name="zip" value="" class="form-control" id="exampleInputZip" type="text">
                    </div>
