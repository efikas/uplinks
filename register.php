...
<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="https://helpinghandsintl.biz/userpaneluser/css/fontello.cssk" rel="stylesheet">
        <!--        <link href="Font-Awesome/css/font-awesome.min.css" rel="stylesheet">-->

        <link href="dashboard_files/css.cssk" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="themify-icons/themify-icons.css">

        <!-- Fonts -->

        <link href="dashboard_files/epoch.cssk" rel="stylesheet" type="text/css">
        <link href="dashboard_files/style.cssl" rel="stylesheet" type="text/css">

        <link href="dashboard_files/verticalbargraph.cssk" rel="stylesheet" type="text/css">
