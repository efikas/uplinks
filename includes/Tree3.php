...
//                dd($value['referredId']);
                ...
                $refererDetail = $_getRef($value['referredId']);
//                $level = 1;
                ...
                if(sizeof($refererDetail) > 0) {
                    array_push($result, [
                        'id'                    => $value,
                        'fullName'              => $user->getFullName($value['referredId']),
...
//        dd($noOfDownlinksPerLevelDetails);
        ...
        if(!$noOfDownlinksPerLevelDetails){
            $noOfDownlinksPerLevelDetails['level1'] = 0;
            $noOfDownlinksPerLevelDetails['level2'] = 0;
            $noOfDownlinksPerLevelDetails['level3'] = 0;
            $noOfDownlinksPerLevelDetails['level4'] = 0;
            $noOfDownlinksPerLevelDetails['level5'] = 0;
            $noOfDownlinksPerLevelDetails['level6'] = 0;
        }
